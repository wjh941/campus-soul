...
export type Assessment={answers:Record<string,unknown>;requirements:Record<string,unknown>;weights:{values:number;lifestyle:number;interests:number;communication:number;intent:number}}
