...
export default function DailyPulse({onOpenAssessment,onNotice,people,onOpen}:{onOpenAssessment:()=>void;onNotice:(text:string)=>void;people:MatchPerson[];onOpen:(person:MatchPerson)=>void}){
