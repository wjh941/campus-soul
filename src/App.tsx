...
function Composer({ onPost, authenticated, avatar }: { onPost: (text: string, image?: File) => Promise<void>; authenticated: boolean; avatar:string }) {
