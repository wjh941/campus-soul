...
const views:View[]=['home','matches','preferences','assessment','moments','anonymous','messages','account','legal','data','admin','profile']
...
function App() {
  ...
  useEffect(()=>{const query=matchMedia('(max-width:760px)');const close=()=>{if(!query.matches)setMobileMenuOpen(false)};query.addEventListener('change',close);return()=>query.removeEventListener('change',close)},[])
